...
const img = {
  ...
  creditCards: asset("/images/home/tiles/credit-cards.png"),
...
const TILES = [
  { label: "Дебетовые карты", count: "1", amount: "16 106 ₽",  subtitle: null,                 src: asset("/images/home/tiles/debit.png"), href: null,        state: "product" },
  ...
  { label: "Накопления",      count: null, amount: null,        subtitle: "до 20%",             src: img.savingsEmptyBox,            href: "/catalog?scenario=anon", state: "cta" },
      ...
      <div style={{ background: S.bgPrimary, borderTop: "1px solid rgba(255,255,255,0.08)", flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", height: 52, padding: "0 4px" }}>
          {[
            ...
            { src: img.tabProd, label: "Продукты", active: false, href: "/products?from=home-anon" },
