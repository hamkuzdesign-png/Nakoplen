...
export default function HomePage() {
  ...
  return (
    <div className="page-enter phone-width" style={{ height: "calc(100svh - env(safe-area-inset-top) - env(safe-area-inset-bottom))", paddingTop: "env(safe-area-inset-top)", display: "flex", flexDirection: "column", background: "#000", overflow: "hidden", position: "relative" }}>
      ...
      {/* ─── scrollable area ─── */}
      <div style={{ flex: 1, overflowY: "auto", overflowX: "hidden", paddingBottom: 86, background: S.bgPrimary }}>

        {/* STATUS BAR + NAVBAR — black header strip */}
        <div style={{ background: S.bgLower }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 24px 4px", height: 44 }}>
          <span style={{ fontFamily: "Inter, sans-serif", fontWeight: 500, fontSize: 12, color: S.textPrimary, letterSpacing: "-0.32px" }}>12:38</span>
          <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
            <Icon src={img.wifi} size={14} />
            <Icon src={img.cell} size={14} />
            <Icon src={img.battery} size={14} />
          </div>
        </div>
