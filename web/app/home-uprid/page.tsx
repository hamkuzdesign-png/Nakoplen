...
/* ── images ── */
const img = {
  bell:       asset("/images/home/box0.svg"),
  search:     asset("/images/home/box1.svg"),
  ...
  savingsEmptyBox: asset("/images/home/tile-savings-empty-box.png"),
  flexEmpty:  asset("/images/home/tile-flex-empty.png"),
  loansEmpty: asset("/images/home/tile-loans-empty.png"),
  investEmpty: asset("/images/home/tile-invest-empty.png"),
  plusCircle: asset("/images/home/icon-plus-circle.svg"),
...
/* state: "product" — уже есть продукт (тёмная карточка, без рамки, сумма)
          ...
          "gov"     — гос-оффер (карточка с рамкой, цветной градиентный фон иконки, кнопка +, подпись) */
const TILES = [
  { label: "Дебетовые карты", count: "2", amount: "16 106 ₽", subtitle: null,            src: asset("/images/home/tiles/debit.png"),        href: null,        state: "product" },
  ...
  { label: "Накопления",      count: null, amount: null,       subtitle: "до 20%",         src: img.savingsEmptyBox,                   href: "/catalog-v2", state: "gov" },
...
export default function HomeUpridPage() {
        ...
        <div style={{ background: S.bgLower, padding: "8px 20px 20px" }}>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
            {TILES.map((tile) => {
              ...
              const isGov = tile.state === "gov";
              const isCallout = isCta || isGov;
              const inner = (
                <div style={{
                  background: isCallout ? "rgba(255,255,255,0.04)" : S.bgPrimary,
                  border: isCallout ? "1px solid rgba(255,255,255,0.08)" : "1px solid transparent",
                  ...
                  <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between" }}>
                    <div style={{
                      background: isGov ? "linear-gradient(135deg, rgb(149,142,255) 0%, rgb(152,216,255) 100%)" : (isCta ? S.white : S.bgSecondary),
                      borderRadius: 16, overflow: "hidden", flexShrink: 0, width: 52, height: 52,
                    }}>
      ...
      <div style={{ background: S.bgPrimary, borderTop: "1px solid rgba(255,255,255,0.08)", flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", height: 52, padding: "0 4px" }}>
          {[
            ...
            { src: img.tabProd, label: "Продукты", active: false, href: "/products?from=home-uprid" },
