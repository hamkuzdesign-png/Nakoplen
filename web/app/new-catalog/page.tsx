...
const FAQ_ITEMS = [
  { id: 1, title: "Накопительные счета", answer: "Накопительный счёт можно открыть в приложении, на сайте или в офисе банка. Опция доступна, даже если у вас уже есть вклады или другие счета, продукты не зависят друг от друга.\n\nПроценты по накопительному счёту начисляются либо на минимальный остаток за месяц, либо на ежедневный — зависит от того, какую опцию по счёту вы выберете. Выплачиваем проценты в конце месяца." },
  { id: 2, title: "Вклады", answer: "Вклад можно открыть в приложении или офисе банка, сроком на 6 или 12 месяцев. Минимальная сумма вклада — 10 000 ₽, ограничений по максимальной сумме нет.\n\nВ отличие от накопительного счёта, вклад нельзя пополнять, частично снять деньги с него тоже не получится." },
  ...
  { id: 4, title: "Цифровые финансовые активы", answer: "Цифровые финансовые активы (ЦФА) — это современные аналоги ценных бумаг или оцифрованных активов, например, недвижимости или драгоценных металлов.\n\nИнвестировать в ЦФА можно в приложении или на сайте. Сначала нужно зарегистрироваться в программе ЦФА, а после выбрать актив и подать заявку на покупку." },
  { id: 5, title: "Металлы", answer: "Драгоценные металлы — это надёжный актив, который защитит деньги от инфляции и других рисков в ситуации валютной нестабильности. К драгоценным металлам относятся: золото, серебро, платина и палладий. Минимальная покупка — 0,1 г." },
  { id: 6, title: "Бонусы за накопления", answer: "Бонусы за накопления — это счёт, на котором нужно держать определённую сумму денег, чтобы получить бонусы. Например, хранить на счёте 50 000 ₽ в течение 30 дней, чтобы получить 15% кешбэка на маркетплейсах." },
];
