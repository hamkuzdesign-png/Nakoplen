...
const screenScreenshots: Record<string, ScreenPreview> = {
  ...
  // В исследованиях могли остаться события старого маршрута /new-catalog.
  // Их показываем на актуальной светлой витрине, а не на устаревшем тёмном
  // снимке. Iframe не запускает скрипты, поэтому не создаёт новые события.
  "/new-catalog": { src: "/catalog-v2", height: 812, live: true },
